...
export interface IVBshipping extends Document {
  ...
  _originalShipId?: string;              // traceability back to the nested sub-doc _id
  createdAt: Date;
  updatedAt: Date;
}
    ...
    shippingTrackingRecords: [
      {
        ...
        pol_name: String,
        pol_date: String,
        pol_actual: Schema.Types.Mixed,
        pod_name: String,
        pod_date: String,
        pod_actual: Schema.Types.Mixed,
        pod_predictive_eta: String,
        container_iso_code: String,
        container_size_type: String,
        vessel_names: String,
