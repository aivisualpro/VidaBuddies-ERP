        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border/40 bg-gradient-to-r from-background to-muted/20 shrink-0">
          <DialogHeader className="p-0 space-y-0">
            <DialogTitle className="text-lg font-bold flex items-center gap-2.5">
              <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/5 border border-blue-500/10 flex items-center justify-center shadow-sm">
          ...
          <div className="divide-y divide-border/30">
            ...
            <div className="flex items-center px-6">
              ...
              <Input
                ...
                className="border-0 shadow-none focus-visible:ring-0 text-sm h-11 px-2"
              />
            </div>
            ...
            <div className="flex items-center px-6">
              ...
              <Input
                ...
                className="border-0 shadow-none focus-visible:ring-0 text-sm font-medium h-11 px-2"
              />
            </div>
            ...
            <div className="px-6 pt-4 pb-4">
              ...
              <textarea
                ...
                className="w-full min-h-[180px] text-sm leading-relaxed bg-transparent border border-border/40 rounded-lg px-4 py-3 resize-y focus:outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/40"
              />
            </div>
